...
public class DepartmentController {
  ...
  public ResponseEntity<WebResponse<List<DepartmentResponse>>> findAllByPagingAndSearch(
      PagingRequest pagingRequest, String inquiry, String status) {
    return ResponseEntity.ok(ResponseHelper.ok(pagingRequest, departmentService.getAll(pagingRequest, inquiry, status)));
  }
